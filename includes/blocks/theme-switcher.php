...
function fse_register_theme_switcher_block() {
    register_block_type( 'fse/theme-switcher', array(
        'render_callback' => function( $attributes ) {
            return '<div class="flex justify-end md:flex-1">
                <div class="pointer-events-auto">
                    <button
                        id="fse-theme-switcher"
                        type="button"
                    ...
                    >
                        ...
                        <svg viewBox="0 0 24 24" aria-hidden="true" class="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition not-[@media_(prefers-color-scheme:dark)]:fill-teal-400/10 not-[@media_(prefers-color-scheme:dark)]:stroke-teal-500 dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400">
