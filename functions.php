...
include_once( get_theme_file_path( '/includes/blocks/front-projects.php' ) );
include_once( get_theme_file_path( '/includes/blocks/project-link.php' ) );
...
include_once( get_theme_file_path( '/includes/cpt/project.php' ) );
...
add_action( 'init', 'fse_register_front_projects_block' );
add_action( 'init', 'fse_register_project_link_block' );
...
add_action( 'init', 'fse_register_project_cpt' );
